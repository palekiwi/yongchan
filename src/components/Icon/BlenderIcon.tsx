...
export const BlenderIcon: React.SFC<Props> = ({ opacity, fill, size }) => (
  <Svg
    width={size || "100%"}
    height={size || "100%"}
    fill={fill}
  ...
  >
    <g fill="#005385" transform="translate(-0.63683287,1.5502632)">
